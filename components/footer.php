					...
					<div class="footer_col">
						<div class="footer_content footer_about">
							...
							<ul class="footer_social_list">
								...
								<li class="footer_social_item"><a target="_blank" href="https://web.facebook.com/horizontravelplus/?_rdc=1&_rdr"><i class="fa fa-facebook-f"></i></a></li>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_tags">
							<ul class="tags_list clearfix">
								...
								<li class="tag_item"><a href="#">aventures</a></li>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text">08 Avenue de la Paix, Commune de la Gombe Kinshasa, Democratic Republic of the Congo</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/phone-call.svg" alt=""></div></div>
									<div class="contact_info_text">+243 844 108 195</div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/message.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="mailto:contact@horizontravelplus.com?Subject=Hello" target="_top">contact@horizontravelplus.com</a></div>
								</li>
								<li class="contact_info_item d-flex flex-row">
									<div><div class="contact_info_icon"><img src="images/planet-earth.svg" alt=""></div></div>
									<div class="contact_info_text"><a href="https://horizontravelplus.com">www.horizontravelplus.com</a></div>
								</li>
							</ul>
						</div>
					</div>
